...
\title[vilperg-senti]{Sentimentanalyse auf Amazon-Reviews} %Einen Kürzel für das Referatsthema angeben (erscheint im zweiten Feld der Fußzeile).
...
\begin{frame}[t]{Vergleichbare Projekte} %text always begins on top
	\begin{itemize}
