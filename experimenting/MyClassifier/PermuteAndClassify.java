...
public class PermuteAndClassify {

    public static void main(String... args) {

        // I concede that the following is an abomination and I swear that
        // I shall never attempt the likes of it again.
        // Please, Java, I beseech you, introduce here documents!
        String usage = new StringBuilder()
            .append("Usage: PermuteAndClassify trainArffFile outDirName ")
            .append("[classifier [testArffFile]]\n\n    Use Weka to train ")
            .append("models on all possible permutations of attributes in\n")
            .append("    trainArffFile and evaluate them on testArffFile. ")
            .append("outDirName is the name of\n    the directory that is ")
            .append("created to hold the results of the evaluation of the\n")
            .append("    models. If testArffFile is not specified, ten-fold ")
            .append("cross evaluation on the\n    trainArffFile is used. ")
            .append("classifier can be one of {J48, RandomForest,\n    ")
            .append("RandomTree, NaiveBayes}. If none is specified, ")
            .append("RandomForest is used.")
            .toString();

        // Print usage string if necessary
        if (args.length < 2) {
